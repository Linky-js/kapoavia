...
<template>
  <section class="Main">
    ...
    <div class="container">
      <breadcrumbs :links="[{ title: 'Главная', link: '/' }, { title: 'Общая информация', link: '' }]">
      </breadcrumbs>
      <div class="Main_info">
        ...
        <p class="Main__text">
          ...
          - проведение работ по установлению и продлению ресурсов (сроков службы)
          авиационной техники;<br>
          - доработка по бюллетеням разработчика (изготовителя) авиационной техники<br>
